...
/* Swerve Profiling Values */
    public static final double maxSpeed = 1.125 / 2.0; // meters per second
    public static final double maxAngularVelocity = 5.75/4.0;
    ...
    public static final class Mod0 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-45.966796875 + 90);
    ...
    public static final class Mod1 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-313.59375 + 90);
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
          canCoderID, angleOffset);
    }
    ...
    public static final class Mod2 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-141.328125 + 90);
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
          canCoderID, angleOffset);
    }
    ...
    public static final class Mod3 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-299.091796875 + 90);
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
          canCoderID, angleOffset);
    }
  }
